...
from app.backend.rei_next.ids import content_id, utc_now
from app.backend.rei_next.models.emocio import EmocioWorld, ImageArtifact
...
from app.backend.rei_next.models.rendering import (
    ImagePipelineSpec,
...
def _identity() -> ProviderIdentity:
    return ProviderIdentity(
        ...
        kind="image_renderer",
        implementation="tests.rei_next.DeterministicPngBackend",
...
def test_null_and_disabled_paths_do_not_import_or_call_heavy_backend(
    ...
    import app.backend.rei_next.emocio.diffusers_renderer as renderer_module
