...
from app.backend.rei.communication.acceptance import (
    assess_acceptance_fidelity,
    validate_acceptance_fidelity_replay,
)
from app.backend.rei.communication.interpreter import (
    DeterministicRacioInterpreter,
    RacioInterpreter,
    ScriptedRacioInterpreter,
    validate_interpretation_replay,
)
from app.backend.rei.communication.fake_vlm import (
    EmocioVlmEnrichment,
...
from app.backend.rei.communication.processor import (
    interpret_manifestations,
    process_communication,
)
from app.backend.rei.communication.translation_gap import (
    evaluate_translation_gap,
    validate_translation_gap_replay,
)
from app.backend.rei.ids import content_id, sha256_hex
from app.backend.rei.instinkt import build_instinkt_manifestation
...
from app.backend.rei.models.instinkt import BodyState, InstinktNativeConclusion
from app.backend.rei.models.provider import (
    ProviderCallSpec,
    ProviderFallbackPolicy,
)
from tests.rei.test_domain_models import _native_bundle
