...
from app.backend.rei.models.emocio import ImageArtifact, VisualSceneSpec
...
from app.backend.rei.models.run import (
    ArtifactHashRecord,
...
def test_run_manifest_serializes_complete_provenance() -> None:
    ...
    manifest = RunManifest(
        ...
        native_assembly=NativeBundleAssemblyRecord(
            ...
            implementation="app.backend.rei.models.run.NativeMindBundle.create",
            implementation_revision="1",
